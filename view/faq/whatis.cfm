...
<p>LightFront is designed to be light in configuration. There is no XML config file, such as Mach-ii, Model Glue and the XML based Fusebox have. Instead, you set your configs in Application.cfc. The framework has defaults, so only set the ones you need.</p>
