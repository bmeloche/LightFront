<cfcomponent persistent="true" table="employee" schema="dbo" output="false">
	...
	<cfproperty name="userID" column="userID" type="numeric" ormtype="integer" />
	<cfproperty name="firstName" column="firstName" type="string" ormtype="string" length="25" />
	<cfproperty name="lastName" column="lastName" type="string" ormtype="string" length="25" />
