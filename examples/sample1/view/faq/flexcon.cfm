...
<p>For example, you can turn off switch based controllers altogether. You can change the default controller and view locations, as well as default events, pre-Events and post-Events.</p>
