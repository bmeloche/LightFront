...
<p>Mind you, you can always define actions any way you want to. There's nothing stopping you if you want to build a CFC method for that action, and I doubt there's nothing wrong with that going forward. You could also call a switch. The benefit of calling views directly means less coding time, less code to create actions, and a cleaner implementation. It's a pragmatic solution to the delivering applications quickly, with quality using LightFront, whether it's a brand new application or an existing one you want to use LightFront in.</p>