...
<div id="main" style="width: 100%;">
	<div id="main_right">
		...
		<p><a href="http://svn.lightfront.org/svn/lightfront/downloads/LightFront_0.4.3_44.zip"><strong>Download Version 0.4.3</a> - The current branch in progress (fully functional core, only the skeleton and skeleton_verbose are certified.)</strong> (.zip)</p>
